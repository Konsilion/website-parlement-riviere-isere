---
title: Usages et gestion des eaux
hide:
  - toc
---

# Usages et gestion des eaux de l'Isère

Cette page présente les informations scientifiques de l'Observatoire : outils, services climatiques, données sur la gestion de l'eau et visualisations interactives.

---

## Carte interactive de la gestion de l'eau

<iframe src="https://embed.kumu.io/b3d59a64f47bc07d82f594c808a8a6b3?scroll=1" style="width:100%; height:600px; border:0;"></iframe>
...
???+ info "Comment les classons-nous"
    ...
    * Les **visualisations** sont des outils interactifs permettant de rapidement obtenir une information utile.
    * Les **études** sont des regroupements de rapports, données travaillées, infographies relativement "complexes" à l'usage.
    * Les **données** sont des jeux de données permettant de réaliser des études ou des visualisations.
